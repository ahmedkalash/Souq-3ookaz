                ...
                <td>
                        ...
                        <tr class="header"
                            ...
                            <td class="header-logo" style="padding: 10px 32px;">
                                <a href="../front-end/index.html" style="display: block; text-align: left;">
                                    <img src="{{ $message->embed(public_path('frontend/assets/images/logo.png')) }}" class="main-logo" alt="logo">
                                </a>
                            </td>
                            ...
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <h3
                                        ...
                                        Hi {{$user->full_name}} And Welcome To Fastkart.!</h3>
                                </td>
                    ...
                    <table class="button-table" style="margin: 34px 0;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <a class="password-button" href="{{route('customer.verify',['verification_code'=>$verification_code])}}">Verify Email</a>
                                </td>
                            </tr>
                        </thead>
                    </table>

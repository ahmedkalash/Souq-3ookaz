@php use App\Services\ProductPriceService; @endphp
                    ...
                    <div class="row g-4">
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ $image->getFullUrl() }}"
                                                             ...
                                                             class="img-fluid image_zoom_cls-{{$loop->index}} blur-up lazyload"
                                                             alt="">
                                                    </div>
                                                </div>
                                            @endforeach
                        ...
                        <div class="col-xl-6 wow fadeInUp">
                            <div class="right-box-contain">
                                {!! $product->isSpecialPriceValid() ?  "<h6 class='offer-top'> {$product->discountPercentage()}% off</h6>" : '' !!}
                                ...
                                <div class="price-rating">
                                    <h3 class="theme-color price">
                                        ...
                                        <span class="offer theme-color">
                                             {!! $product->isSpecialPriceValid() ?  "({$product->discountPercentage()}% off)" : '' !!}
                                        </span></h3>
                                ...
                                <div class="note-box product-packege">
                                    <div class="cart_qty qty-box product-qty">
                                        <div id="add-main-product-to-cart">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control input-number qty-input product-{{$product->id}}-cart-qty"
                                                       type="text"
                                    ...
                                    <div class="input-group">
                                        <button id="main-product-add-to-cart-btn"
                                                class="btn btn-md bg-dark cart-button text-white w-100 add-to-cart-ajax"
                                                ...
                                                <ul>
                                                        ...
                                                        <div class="rating-list">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: {{$product->reviews->ratings_percentage[5]??0}}%"
                                                                     aria-valuenow="100"
                                                    ...
                                                    <li>
                                                        <div class="rating-list">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: {{$product->reviews->ratings_percentage[4]??0}}%"
                                                                     aria-valuenow="100"
                                                                     aria-valuemin="0" aria-valuemax="100">
                                                    ...
                                                    <li>
                                                        <div class="rating-list">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: {{$product->reviews->ratings_percentage[3]??0}}%"
                                                                     aria-valuenow="100"
                                                                     aria-valuemin="0" aria-valuemax="100">
                                                    ...
                                                    <li>
                                                        <div class="rating-list">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: {{$product->reviews->ratings_percentage[2]??0}}%"
                                                                     aria-valuenow="100"
                                                                     aria-valuemin="0" aria-valuemax="100">
                                                    ...
                                                    <li>
                                                        <div class="rating-list">
                                                            ...
                                                            <div class="progress">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: {{$product->reviews->ratings_percentage[1]??0}}%"
                                                                     aria-valuenow="100"
                                                                     aria-valuemin="0" aria-valuemax="100">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="row g-4">
                                                <form class="row g-4" method="post"
                                                      action="{{route('customer.product.storeReview', $product->id)}}">
                                                    @csrf
                                                    <div class="col-md-6">
                                                        <div class="form-floating theme-form-floating">
                                                            <input type="number" class="form-control" id="review1"
                                                                   placeholder="Rate" max="5" min="0" name="rate"
                                                                   value="{{$current_user_review?->rate}}" required>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-floating theme-form-floating">
                                                            <button type="submit"
                                                                    class="btn theme-bg-color text-white">{{__('product-bundle.submit')}}</button>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <li>
                                                            <div class="people-box">
                                                                ...
                                                                <div class="people-comment">
                                                                    <a class="name"
                                                                       href="javascript:void(0)">{{$review->user->full_name}}</a>
                                                                    <div class="date-time">
                                            ...
                                            <div class="add-to-cart-box bg-white">
                                                ...
                                                <div class="cart_qty qty-box" style="display: flex">
                                                    <div class="input-group bg-white">
                                                        ...
                                                        <input class="form-control input-number qty-input product-{{$related_product->id}}-cart-qty"
                                                               type="text"
                                                               name="qty" value="1">
                                                    ...
                                                    <button id="main-product-add-to-cart-btn"
                                                            class="btn theme-bg-color text-white add-to-cart-ajax"
